"""
Upload YouTube cookies to R2 storage
...
# Upload cookies file
cookies_file = 'youtube_cookies_only.txt'
if not os.path.exists(cookies_file):
    print(f"❌ Error: {cookies_file} not found!")
    print(f"Please extract cookies first:")
    print(f'yt-dlp --cookies-from-browser chrome --cookies {cookies_file} "https://www.youtube.com/"')
    exit(1)
